...
class Player(Entity):
    ...
    def move(self, ): #movimento do jogador
        ...
        if pressed_key[PLAYER_KEY_RIGHT[self.name]] and self.rect.bottom < WIN_WIDTH: #faz o player nave ir pra DIREITA quando (>) é pressionado, WinWidth evita o player sair da tela
            self.rect.centerx += ENTITY_SPEED[self.name]
        pass
